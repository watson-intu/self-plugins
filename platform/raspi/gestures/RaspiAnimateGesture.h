...
#ifndef RASPI_ANIMATE_GESTURE_H
#define RASPI_ANIMATE_GESTURE_H

#include "gestures/AnimateGesture.h"

//! This is the class for animating a Raspberry Pi, such as changing LED colors.
class RaspiAnimateGesture : public AnimateGesture
{
public:
	RTTI_DECL();
	...
	//! Construction
	RaspiAnimateGesture() : m_PinNumber( 7 ), m_bWiredPi( false )
	{}
