...
#include "../sensors/WinMicrophone.h"

class TestWinMicrophone : UnitTest
{
public:
	//! Construction
	TestWinMicrophone() : UnitTest( "TestDSMicrophone" ), m_AudioReceived( false )
	{}
	...
	virtual void RunTest()
	{
		ThreadPool pool(1);
		WinMicrophone mic;
		mic.Subscribe( DELEGATE( TestWinMicrophone, ReceiveAudio, IData *, this ) );
