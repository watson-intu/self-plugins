...
public:
	...
	//! Set volume level
	void SetCurrentVolume( float a_fCurrentVolume );
	//! Volumet notifiers
	void AddVolumeNotifier( Delegate<float> a_Delegate );
	bool RemoveVolumeNotifier( void * a_pObject );
...
private:
	...
	DelegateList<float> m_VolumeNotifierList;
